...
CirclePlayer.prototype = {
	...
	_initPlayer: function() {
		...
		this.player.bind(jQuery.jPlayer.event.ready + this.eventNamespace, function(event) {
			...
			var str = jQuery.cookie('radio_vera_play');

			if(str=='yes'){
				jQuery(this).jPlayer("setMedia", self.media).jPlayer('play');  // To make Autoplay on -
			}else{					
		...
		this.player.bind(jQuery.jPlayer.event.pause + this.eventNamespace, function(event) {
			document.cookie = "radio_vera_play=no;path=/";
	...
	setMedia: function(media) {
		this.media = jQuery.extend({}, media);
	      	this.player.jPlayer("setMedia", this.media);  // Makes PlayerAutoplay off -
            //this.player.jPlayer("setMedia", this.media).jPlayer('play');  // To make Autoplay on -
	},
	play: function(time) {
